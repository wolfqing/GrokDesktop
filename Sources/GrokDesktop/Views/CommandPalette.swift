...
struct CommandPalette: View {
    ...
    private var commands: [CommandItem] {
        ...
        var rows: [CommandItem] = [
            ...
            .init(command: "/rewind", title: l10n.t("Rewind", "回退"), detail: l10n.t("Pick a turn to rewind to", "选择要回退到的轮次"), icon: "arrow.uturn.backward", section: session),
            ...
            .init(command: "/find", title: l10n.t("Find", "查找"), detail: l10n.t("Search this conversation", "搜索当前对话"), icon: "magnifyingglass", section: session, insertsIntoDraft: true),
            .init(command: "/timeline", title: l10n.t("Timeline", "时间线"), detail: l10n.t("Jump to a user turn", "跳到某一轮用户提示"), icon: "list.bullet", section: session),
            ...
            .init(command: "/memory", title: l10n.t("Memory", "记忆"), detail: l10n.t("Browse memory files", "浏览记忆文件"), icon: "brain", section: memory),
            ...
            .init(command: "/context", title: l10n.t("Context", "上下文"), detail: l10n.t("Category breakdown of the window", "按类别查看上下文占用"), icon: "info.circle", section: app),
            .init(command: "/agents", title: l10n.t("Agents", "Agents"), detail: l10n.t("Manage agent definitions", "管理 agent 定义"), icon: "person.2", section: app),
            .init(command: "/personas", title: l10n.t("Personas", "人设"), detail: l10n.t("Create and edit personas", "创建和编辑人设"), icon: "theatermasks", section: app),
            ...
            .init(command: "/hooks", title: l10n.t("Hooks", "Hooks"), detail: l10n.t("Show the hook timeline", "查看钩子时间线"), icon: "link", section: app),
            .init(command: "/mcps", title: l10n.t("MCP servers", "MCP"), detail: l10n.t("Manage MCP servers", "管理 MCP 服务器"), icon: "server.rack", section: app),
            .init(command: "/workflows", title: l10n.t("Workflows", "工作流"), detail: l10n.t("Open the run dashboard", "打开运行面板"), icon: "arrow.triangle.swap", section: app),
